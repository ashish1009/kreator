...
namespace physics {
  ...
  public:
    ...
    /// - Parameters:
    ///   - vertices/// - Parameters: an array of vertices, these are copied
    ///   - count/// - Parameters: the vertex count
    ///   - prevVertex/// - Parameters: previous vertex from chain that connects to the start
    ///   - nextVertex/// - Parameters: next vertex from chain that connects to the end
